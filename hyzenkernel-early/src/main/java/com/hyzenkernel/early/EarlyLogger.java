...
/**
 * Centralized logging for the HyzenKernel Early Plugin with verbose gating.
 * 
 * Usage:
 ...
 * - JVM: -Dhyzenkernel.verbose=true
 */
public class EarlyLogger {
    
    private static final String PREFIX = "[HyzenKernel-Early] ";
